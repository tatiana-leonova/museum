      ...
      filterItems: {
        ...
        plot: {
          ...
          items: {
            ...
            scenery: "Пейзаж",
            literaryScene: "Литературная сцена",
            urbanLandscape: "Городской пейзаж",
            nude: "Ню",
            interior: "Интерьер",
            stillLife: "Натюрморт",
            allegoricalScene: "Аллегорическая сцена",
        ...
        year: {
          title: "Период",
          items: ["до 1900", "1901-1916", "1917 и позже"],
        },
      },
    };
  },
